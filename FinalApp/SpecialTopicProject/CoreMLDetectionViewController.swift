//
//  CoreMLDetectionViewController.swift
//  SpecialTopicProject
//
//  Created by Preethi Srinviasan on 12/7/17.
...
import CoreMedia
import Vision
class CoreMLDetectionViewController: UIViewController,UIImagePickerControllerDelegate {

    
    @IBOutlet weak var predictLabel: UILabel!
    @IBOutlet weak var predictView: UIView!
    @IBOutlet weak var visionView: UISwitch!
    
    @IBOutlet weak var predictionLabel: UILabel!
    let inceptionv3model = Inceptionv_3()
    ...
    override func viewDidLoad() {
        ...
        videoCapture = VideoCapture(cameraType: .back,
                                    preferredSpec: spec,
                                    previewContainer: predictView.layer)
        
        videoCapture.imageBufferHandler = {[unowned self] (imageBuffer) in
            if self.visionView.isOn {
                // Use Vision
